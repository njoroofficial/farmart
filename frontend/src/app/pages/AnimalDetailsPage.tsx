    ...
    <div className="bg-[#F7F4EF] min-h-screen py-6">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
          <button
            onClick={() => navigate(-1)}
            className="flex items-center gap-1 hover:text-[#2D6A4F]"
          >
            <ArrowLeft className="w-4 h-4" /> Back
          </button>
          <ChevronRight className="w-3.5 h-3.5" />
          <Link to="/marketplace" className="hover:text-[#2D6A4F]">
            Marketplace
          </Link>
          <ChevronRight className="w-3.5 h-3.5" />
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 mb-3">
              <span
                className={`text-xs px-2 py-1 rounded-full ${TYPE_COLORS[animal.animal_type.name] || "bg-gray-100 text-gray-700"}`}
              >
            ...
            <h1 className="text-[#1B2D1B] text-2xl font-bold mb-1">
              {animal.name}
            </h1>
            <p className="text-gray-500 mb-3">
              {animal.breed.name} · {animal.farmer.farm_name}
            </p>
