...
const NAV = [
  ...
  { label: "My Listings", to: "/farmer/listings", icon: List },
  { label: "Add Animal", to: "/farmer/listings/add", icon: PlusCircle },
  { label: "Orders", to: "/farmer/orders", icon: Package },
];
        ...
        <div className="px-4 py-4 border-b border-white/10">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[#52B788] text-xs truncate">
                {currentUser?.farm_name || "Farmer"}
              </p>
            </div>
          </div>
        </div>
